# -*- coding: utf-8 -*-
"""
Created on Fri Jul  2 16:09:46 2021
...
FBSDict={
    ...
    "UnempPrb" : 0.08, #.08                     # Probability of unemployment while working
    "IncUnemp" :  .2, #0.0954, #0.29535573122529635,                      # Unemployment benefits replacement rate
    "UnempPrbRet" : 0.0005,                # Probability of "unemployment" while retired
    "IncUnempRet" : 0.0,                   # "Unemployment" benefits when retired
    "T_retire" : 0,                        # Period of retirement (0 --> no retirement)
    "tax_rate" : .1, #0.16563445378151262,                      # Flat income tax rate (legacy parameter, will be removed in future)
...
center = 0.961 #.9773 #98 
#0.9778688120928881 for one agent
while go:
    
    discFacDispersion = 0.0075
