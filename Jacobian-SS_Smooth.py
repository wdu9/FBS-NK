...
IdiosyncDict={
    ...
    "BoroCnstArt" : - 0.05,                   # Artificial borrowing constraint; imposed minimum level of end-of period assets
...
plt.plot(CHist[4], label = '40')
plt.plot(CHist[3], label = '15')
#plt.ylim([.24,.25])
plt.legend()
plt.show()


plt.plot((CHist[4]- C_dx0)/(jac_agent.dx), label = '40')
plt.plot((CHist[3]- C_dx0)/(jac_agent.dx), label = '15')
#plt.plot((CHist[2] - C_dx0)/(jac_agent.dx), label = '5')
plt.plot((CHist[1]- C_dx0)/(jac_agent.dx), label = '1')
...
plt.plot((CHist[4]- C_dx0)/(.01), label = '40')
plt.plot((CHist[3]- C_dx0)/(.01), label = '15')
#plt.plot((CHist[2] - C_dx0)/(jac_agent.dx), label = '5')
