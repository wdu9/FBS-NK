# -*- coding: utf-8 -*-
"""
Created on Wed Jun  9 02:05:38 2021
...
def GHHutility(c,n,v,varphi, gam):
    """
...
def GHHutilityP(c,n,v,varphi, gam):
    """
...
def GHHutilityPP(c,n,v,varphi, gam):
    """
...
def GHHutilityPPP(c,n,v,varphi, gam):
    """
...
def GHHutilityPPPP(c,n,v,varphi, gam):
    """
    Evaluates constant relative risk aversion (CRRA) marginal marginal marginal
...
def GHHutility_inv(u,n,v,varphi, gam):
    """
...
def GHHutilityP_inv(uP,n,v,varphi, gam):
    """
...
def GHHutility_invP(u,n,v,varphi, gam):
    """
...
def GHHutilityP_invP(uP,n,v,varphi, gam):
    """
...
class ValueFuncGHH(MetricObject):
    ...
    def __init__(self, vFuncNvrs, CRRA,n,v,varphi):
    ...
    def __call__(self, *vFuncArgs):
        ...
        """
        return GHHutility(self.func(*vFuncArgs), gam=self.CRRA, n = self.n, varphi = self.varphi, v = self.v)
...
class MargValueFuncGHH(MetricObject):
    ...
    def __init__(self, cFunc, CRRA, v, varphi, n):
    ...
    def __call__(self, *cFuncArgs):
        ...
        vP : float or np.array
            ...
            cFuncArgs
        """
        return GHHutilityP( self.cFunc(*cFuncArgs), gam=self.CRRA , n = self.n, varphi = self.varphi , v = self.v)
    ...
    def derivativeX(self, *cFuncArgs):
        ...
        return MPC * GHHutilityPP(c, gam=self.CRRA , n = self.n, varphi = self.varphi , v = self.v)
