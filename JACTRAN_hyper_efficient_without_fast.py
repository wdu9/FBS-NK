...
class JACTran(IndShockConsumerType):
    ...
    def calc_ergodic_dist(self, transition_matrix = None):
        ...
        transition_matrix: np.array
                    transition matrix whose ergordic distribution will be solved for
...
while go:
    ...
    Css =  np.dot(c,ss.vec_erg_dstn)
    AggA =np.dot(asset,ss.vec_erg_dstn)
...
#for q in testset:
    ...
    example.calc_agg_path(init_dstn = ss.vec_erg_dstn)
